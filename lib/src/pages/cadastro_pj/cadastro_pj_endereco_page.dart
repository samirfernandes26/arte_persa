...
class CadastroPjEnderecoPage extends ConsumerStatefulWidget {
  const CadastroPjEnderecoPage({super.key});

  @override
  ConsumerState<CadastroPjEnderecoPage> createState() =>
      _CadastroPjEnderecoPageState();
}

class _CadastroPjEnderecoPageState
    extends ConsumerState<CadastroPjEnderecoPage> {
