...
part of 'imagem_ordem_servico_model.dart';

// **************************************************************************
// JsonSerializableGenerator
// **************************************************************************

ImagemOrdemServicoModel _$ImagemOrdemServicoModelFromJson(
    ...
    ImagemOrdemServicoModel(
      ...
      ordemExibicao: (json['ordem_exibicao'] as num).toInt(),
...
Map<String, dynamic> _$ImagemOrdemServicoModelToJson(
        ImagemOrdemServicoModel instance) =>
    <String, dynamic>{
      'id': instance.id,
      ...
      'ordem_exibicao': instance.ordemExibicao,
